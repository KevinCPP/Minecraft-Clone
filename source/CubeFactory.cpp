...
namespace Blocks {
    ...
    CubeFactory::CubeFactory() {
        ...
        cubes[DEV]        .setTextureArrayIndex(TOP,      (float)texArray->getIndex("test_top.bmp"            ));
        cubes[DEV]        .setTextureArrayIndex(LEFT,     (float)texArray->getIndex("test_left.bmp"           ));
        cubes[DEV]        .setTextureArrayIndex(BACK,     (float)texArray->getIndex("test_back.bmp"           ));
        cubes[DEV]        .setTextureArrayIndex(FRONT,    (float)texArray->getIndex("test_front.bmp"          ));
        cubes[DEV]        .setTextureArrayIndex(RIGHT,    (float)texArray->getIndex("test_right.bmp"          ));
        cubes[DEV]        .setTextureArrayIndex(BOTTOM,   (float)texArray->getIndex("test_bottom.bmp"         ));
        ...
        cubes[GRASS_BLOCK].setTextureArrayIndex(TOP,      (float)texArray->getIndex("grass_block_top.bmp"     ));
        cubes[GRASS_BLOCK].setSidesTextureArrayIndex(     (float)texArray->getIndex("grass_block_sides.bmp"   ));
        cubes[GRASS_BLOCK].setTextureArrayIndex(BOTTOM,   (float)texArray->getIndex("dirt.bmp"                ));
